...
// http://www.java2s.com/Tutorials/Java/Java_Regular_Expression/0070__Java_Regex_Groups.htm    
    ...
    ***************************************************/
    void regexExamples(){
        ...
        Pattern pat1 = Pattern.compile("-"); // Atpazinsta neigiamus skaicius
        Pattern pat2 = Pattern.compile("[a-zA-Z]+"); // Atpazysta lotyniskas raides
        Pattern pat3 = Pattern.compile("[a-zA-Zą-žĄ-Ž]+"); // Atpazysta lietuviskas raides
        //Pattern pat = Pattern.compile(sa[0]);      // pirma dalis - tai Pattern
        Matcher m = pat1.matcher(ta1.getText());            // kita dalis - apdorojimui
