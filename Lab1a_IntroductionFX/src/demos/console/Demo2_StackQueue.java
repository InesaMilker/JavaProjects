...
public class Demo2_StackQueue extends BaseConsole{
    ...
    private int click;
    final private ArrayList<String> stringy = new ArrayList<String>();
    ...
    private void poolQueue() {
        queue.poll(); // Pasalina Head ir Grazina jos verte
        ta1.appendText(queue.toString()+nL);
    }
    ...
    private void doStuffWithString() {
        stringy.add(readLastLine());
    }
    ...
    public void createControls() {
        ...
        addButton("epic string add", e -> doStuffWithString());
        addButton("epic display string", e -> displayString());
    }
